      ...
      <View className="space-y-6">
        <View className="mb-4">
          ...
          <View className="bg-indigo-50 dark:bg-indigo-900/30 p-5 rounded-2xl border border-indigo-100 dark:border-indigo-800">
            ...
            <Text className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
              Yeni kelimeleri öğrenirken, her kelime için bir örnek cümle
              oluşturun. Bu, kelimenin bağlamını anlamanıza ve daha kalıcı
        ...
        <View className="mb-4">
          ...
          <View className="bg-emerald-50 dark:bg-emerald-900/30 p-5 rounded-2xl border border-emerald-100 dark:border-emerald-800">
            ...
            <Text className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
              Podcast veya film izlerken, duyduğunuz yeni kelimeleri ve
              ifadeleri not alın. Daha sonra bu notları kategorize ederek tekrar
              edin.
            </Text>
          </View>
        </View>
        ...
        <View className="mb-4">
          ...
          <View className="bg-amber-50 dark:bg-amber-900/30 p-5 rounded-2xl border border-amber-100 dark:border-amber-800">
            ...
            <Text className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
              Notlarınızı dil bilgisi, kelime, deyimler gibi kategorilere
              ayırarak düzenleyin. Bu, öğrenme sürecinizi daha organize ve
        ...
        <View className="mt-4">
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            {templates.map((template, index) => (
              <View
                key={index}
                className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg mx-2 border border-gray-200 dark:border-gray-700 mt-4 w-64 gap-2 mb-4"
              >
